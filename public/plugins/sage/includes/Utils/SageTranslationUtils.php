    ...
    public static function getTranslations(): array
    {
        return [
            ...
            self::TRANS_FARTICLES => [
                ...
                "arRaccourci" => __("Raccourci", 'sage'),
                "arGarantie" => __("arGarantie", 'sage'),
                "arUnitePoids" => [
                    'label' => __("Unité de poids", 'sage'),
                    'values' => [
                        '0' => __("Tonne", 'sage'),
                        '1' => __("Quintal", 'sage'),
                        '2' => __("Kilogramme", 'sage'),
                        '3' => __("Gramme", 'sage'),
                ...
                "arEscompte" => __("Ne pas soumettre à l'escompte", 'sage'),
                "arDelai" => __("arDelai", 'sage'),
                "arHorsStat" => __("Exclure des statistiques", 'sage'),
                "arVteDebit" => __("Vendre au débit", 'sage'),
                "arNotImp" => __("Ne pas imprimer", 'sage'),
                "arSommeil" => __("Mettre en sommeil", 'sage'),
                "arLangue1" => __("Langue 1", 'sage'),
                "arLangue2" => __("Langue 2", 'sage'),
                "arCodeBarre" => __("Code barre", 'sage'),
                "arCodeFiscal" => __("Code fiscal", 'sage'),
                "arPays" => __("Pays d'origine", 'sage'),
                ...
                "arContremarque" => __("Gérer en contremarque", 'sage'),
                "arFactPoids" => __("Facturer / Poids brut", 'sage'),
                "arFactForfait" => __("Facturer au forfait", 'sage'),
                "arSaisieVar" => __("arSaisieVar", 'sage'),
                "arTransfere" => __("arTransfere", 'sage'),
                "arPublie" => __("Publier sur le site marchand", 'sage'),
